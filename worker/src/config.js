...
const config = {
  ...
  session: {
    localPath:  path.resolve(process.cwd(), process.env.SESSION_LOCAL_PATH || './data/state.json'),
  ...
  paths: {
    tmpImageDir: path.resolve(process.cwd(), process.env.TMP_IMAGE_DIR || './data/images'),
  },
